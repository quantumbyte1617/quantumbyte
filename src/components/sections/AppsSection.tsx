              ...
              >
                <div className="flex items-start justify-between mb-5">
                  ...
                  {app.status === "live" ? (
                    ...
                    <span className="px-2.5 py-1 rounded-full text-[10px] font-medium bg-white/5 text-text-muted border border-white/5 uppercase tracking-wider">
                      Coming Soon
                    </span>
                  )}
                </div>
                ...
                {app.status === "live" ? (
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-[11px] text-text-muted/60">Progress</span>
                      <span className="text-[11px] text-text-muted/60">{app.progress}%</span>
                    </div>
                    <div className="progress-bar">
                      <div
                        className={`progress-bar-fill ${app.accentBg}`}
                        style={{ width: `${app.progress}%`, opacity: 0.6 }}
                      />
                    </div>
                  </div>
                ) : null}
